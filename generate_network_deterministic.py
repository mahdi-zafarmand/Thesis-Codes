...
num_nodes = 1000             # number of nodes in the generated network
...
mu = 0.2                    # faction of links between communities: must be in [0, 0.5]
avg_degree = 60             # average degree of nodes: must be in [0, num_nodes]
max_degree = 200             # maximum degree of a node in the graph: must be less than num_ndoes
