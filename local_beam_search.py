...
def find_best_state(forward_scores, external_scores):
	...
	# print(forward_scores, len(forward_scores))
...
def community_search(graph, intended_node):
	...
	while len(community) < graph.number_of_nodes():
		...
		# print('best_state =', best_state, ' score =', forward_scores[best_state])
		...
		if new_score >= old_score:
			Tin = calc_T_in(graph, best_next_node, community, Tin)
			Tout = calc_T_out(graph, best_next_node, community, Tout)
			old_score = new_score
